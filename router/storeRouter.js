...
//local modules
const { homepage, getDetails, availableHomes, postFavorites, getFavoritesList, postremoveFavorite, getHouseRules, getBooked } = require('../controllers/storecontroller');
