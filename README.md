...
<li>Tech Stack- MongoDB, Moongoose, Express,Node,Tailwind,.ejs templates <br>
<li>bcrypt package  to encrypt ,expreess Validator to validate password <br>
<li>sendgrid api to send mails and otp for user authentication and password reseting.
